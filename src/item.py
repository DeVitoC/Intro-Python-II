...
##################
class Armor(Item):
	def __init__(self, name, description, armor_value, slot):
		super().__init__(name, description)
...
class Legguard(Armor):
	def __init__(self, name, description, armor_value, slot = ArmorSlot.LEGS):
		super().__init__(name, description, armor_value, slot)

class Ring(Armor):
	def __init__(self, name, description, armor_value = 0, slot = ArmorSlot.FINGER):
		super().__init__(name, description, armor_value, slot)
